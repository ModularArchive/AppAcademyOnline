...
require "00_hello" #This makes specified ruby files and their data accessible

describe "the hello function" do #describe is 
  it "says hello" do
    expect(hello).to eq("Hello!") #expect hello to equal Hello!   
  end #(the hello being referenced is the one defined in 00_hello) (The Hello! being referenced is the string within the function)
end

describe "the greet function" do
  it "says hello to someone" do
    expect(greet("Alice")).to eq("Hello, Alice!") #Same as above however referencing the greet function
  end
